...
FixedHeader = function ( mTable, oInit ) {
	...
	{
		swal( "FixedHeader warning: FixedHeader must be initialised with the 'new' keyword." );
		return;
	}
...
FixedHeader.prototype = {
	...
	fnInit: function ( oDtSettings, oInit )
	{
		...
		{
			swal( "FixedHeader 2 is not supported with DataTables' scrolling mode at this time" );
			return;
		}
