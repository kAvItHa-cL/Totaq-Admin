...
var Scroller = function ( oDTSettings, oOpts ) {
	...
	{
		swal( "Scroller warning: Scroller must be initialised with the 'new' keyword." );
		return;
	}
...
Scroller.prototype = /** @lends Scroller.prototype */{
	 ...
	 *          swal( o.oScroller.fnRowToPixels( 25 ) );
	 *        }
	 *      } );
	 *    } );
	 */
	 ...
	 *          swal( o.oScroller.fnPixelsToRow( 500 ) );
	 *        }
	 *      } );
	 *    } );
	 */
...
{
	swal( "Warning: Scroller requires DataTables 1.9.0 or greater - www.datatables.net/download");
}
