...
TableTools = function( oDT, oOpts )
{
	...
	{
		swal( "Warning: TableTools must be initialised with the keyword 'new'" );
	}
	...
	"_fnButtonDefinations": function ( buttonSet, wrapper )
	{
		...
		for ( var i=0, iLen=buttonSet.length ; i<iLen ; i++ )
		{
			if ( typeof buttonSet[i] == "string" )
			{
				...
				{
					swal( "TableTools: Warning - unknown button type: "+buttonSet[i] );
					continue;
				}
			...
			else
			{
				...
				{
					swal( "TableTools: Warning - unknown button type: "+buttonSet[i].sExtends );
					continue;
				}
	...
	"ajax": $.extend( {}, TableTools.buttonBase, {
		...
		"fnClick": function( nButton, oConfig ) {
			...
			$.ajax( {
				...
				"cache": false,
				"error": function () {
					swal( "Error detected when sending table data to server" );
				}
			} );
		},
...
{
	swal( "Warning: TableTools requires DataTables 1.9.0 or newer - www.datatables.net/download");
}
...
{
	swal( "Warning: TableTools 2 requires DataTables 1.9.0 or newer - www.datatables.net/download");
}
