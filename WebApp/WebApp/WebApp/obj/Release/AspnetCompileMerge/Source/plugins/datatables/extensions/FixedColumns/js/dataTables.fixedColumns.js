...
var FixedColumns = function ( dt, init ) {
	...
	{
		swal( "FixedColumns warning: FixedColumns must be initialised with the 'new' keyword." );
		return;
	}
...
FixedColumns.prototype = /** @lends FixedColumns.prototype */{
	...
	"_fnConstruct": function ( oInit )
	{
		...
		{
			swal( "FixedColumns "+FixedColumns.VERSION+" required DataTables 1.8.0 or later. "+
